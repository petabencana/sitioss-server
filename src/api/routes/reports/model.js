...
export default (config, db, logger) => ({
  all: (timeperiod, admin, disasterType) =>
    new Promise((resolve, reject) => {
      ...
      the_geom, ${config.TABLE_COGNICITY_PARTNERS}.partner_code ,${config.TABLE_COGNICITY_PARTNERS}.partner_icon FROM ${config.TABLE_REPORTS}
      INNER JOIN ${config.TABLE_COGNICITY_PARTNERS} ON ${config.TABLE_REPORTS}.partner_code=${config.TABLE_COGNICITY_PARTNERS}.partner_code
